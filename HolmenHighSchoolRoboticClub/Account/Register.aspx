<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="HolmenHighSchoolRoboticClub.Account.Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label ID="UserRole" runat="server" Text="User Role" CssClass="col-md-2 control-label"></asp:Label>
            <div class="col-md-10">
                <asp:DropDownList ID="Roles" runat="server" Height="44px" Width="209px" CssClass="form-control">
